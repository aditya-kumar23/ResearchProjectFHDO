...
This section describes how the network conditions from the methodology are realised: impairments are injected at the message level inside the ROS~2 publish paths and are applied consistently across architectures.
